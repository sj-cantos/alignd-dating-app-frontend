...
export function Navigation() {
  ...
  return (
    <nav className="bg-card border-b-brutal border-border shadow-brutal sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Mobile Navigation */}
        <div className="md:hidden border-t-2 border-border bg-sidebar-background">
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  onClick={() => router.push(item.path)}
                  className={`
                    flex flex-col items-center px-3 py-2 rounded-lg font-bold text-xs
